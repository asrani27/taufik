...
@section('title', 'Edit Jenis Pelanggaran - SMKN 2 SIMPANG EMPAT Tanah Bumbu')

@section('topbar')
<div class="bg-white shadow-md px-8 py-4">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Edit Jenis Pelanggaran</h2>
            <p class="text-gray-600">Edit data jenis pelanggaran</p>
        </div>
