...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-2xl font-bold text-gray-800">Tambah Pelanggaran Siswa</h2>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.pelanggaran-siswa.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="jenis_pelanggaran_id" name="jenis_pelanggaran_id" required
                            ...
                            <option value="{{ $jenis->id }}">{{ $jenis->nama }} (Poin: {{ $jenis->poin }})</option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="catatan" name="catatan" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Catatan tambahan dari guru..."></textarea>
                        @error('catatan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <textarea id="tindak_lanjut" name="tindak_lanjut" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Tindak lanjut yang akan dilakukan..."></textarea>
                    @error('tindak_lanjut')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
