...
<body>
    ...
    <div class="container">
        ...
        <div class="judul">
            <h4>LAPORAN DATA JENIS PELANGGARAN</h4>
        </div>
        ...
        <table>
            ...
            <tbody>
                @forelse($jenisPelanggarans ?? [] as $i => $jenisPelanggaran)
                <tr>
                    <td>{{ $i + 1 }}</td>
                    <td>{{ $jenisPelanggaran->kode }}</td>
                    <td>{{ $jenisPelanggaran->nama }}</td>
                    <td>{{ $jenisPelanggaran->poin }}</td>
                </tr>
                @empty
                <tr>
