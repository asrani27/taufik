...
<body>
    ...
    <div class="container">
        ...
        <div class="judul">
            <h4>LAPORAN DATA KEPALA SEKOLAH</h4>
        </div>
        ...
        <table>
            ...
            <tbody>
                @forelse($kepalaSekolahs ?? [] as $i => $kepalaSekolah)
                <tr>
                    <td>{{ $i + 1 }}</td>
                    <td>{{ $kepalaSekolah->nip }}</td>
                    <td>{{ $kepalaSekolah->nama }}</td>
                    <td>{{ $kepalaSekolah->pangkat }}</td>
                    <td>{{ $kepalaSekolah->tanggal_menjabat ? $kepalaSekolah->tanggal_menjabat->translatedFormat('d F Y') : '-' }}</td>
                </tr>
                @empty
                <tr>
