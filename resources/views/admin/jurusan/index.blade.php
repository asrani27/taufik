...
@section('title', 'Data Jurusan - SMKN 2 SIMPANG EMPAT Tanah Bumbu')
...
<div class="bg-white shadow-md px-8 py-4">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Kelola data jurusan SMKN 2 SIMPANG EMPAT</p>
        </div>
...
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
    <form action="{{ route('admin.jurusan.index') }}" method="GET">
        <div class="flex items-center space-x-4">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                        {{ ($jurusans->currentPage() - 1) * $jurusans->perPage() + $loop->index + 1 }}
                    </td>
                ...
                <tr>
                    <td colspan="4" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-gray-500 text-lg">Tidak ada data jurusan ditemukan</p>
                            <p class="text-gray-400 text-sm mt-1">Silakan tambah data jurusan baru</p>
                        </div>
                    </td>
                </tr>
                @endforelse
