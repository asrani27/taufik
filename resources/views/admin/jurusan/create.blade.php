...
@section('title', 'Tambah Jurusan - SMKN 2 SIMPANG EMPAT Tanah Bumbu')
...
<div class="bg-white shadow-md px-8 py-4">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Tambahkan data jurusan baru</p>
        </div>
        ...
        <form action="{{ route('admin.jurusan.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" 
                    ...
                    placeholder="Contoh: TKJ, RPL, TKR"
                    required>
                <p class="mt-1 text-sm text-gray-500">Kode unik untuk jurusan (maksimal 10 karakter)</p>
            </div>
