...
@section('title', 'Tambah Kepala Sekolah - SMKN 2 SIMPANG EMPAT Tanah Bumbu')

@section('topbar')
<div class="bg-white shadow-md px-8 py-4">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Tambah Kepala Sekolah</h2>
            <p class="text-gray-600">Tambahkan data kepala sekolah baru</p>
        </div>
